    ...
    <div style={{ background:'white', border:'1px solid var(--border)', marginBottom:16, borderLeft:`4px solid ${color}` }}>
      <div style={{ padding:'20px 24px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:12 }}>
          ...
          <span style={{ fontFamily:'var(--font-mono)', fontSize:10, color:'var(--text3)' }}>{item.country}</span>
          <span style={{ fontFamily:'var(--font-mono)', fontSize:10, color:'var(--text3)' }}>{item.date}</span>
  ...
  return (
    <div>
      <div style={{ marginBottom:20 }}>
        <h2 style={{ fontFamily:'var(--font-display)', fontWeight:700, fontSize:22, marginBottom:6 }}>Regulatory Intelligence Feed</h2>
        <p style={{ fontFamily:'var(--font)', color:'var(--text2)', fontSize:14, lineHeight:1.6 }}>
      ...
      {filtered.length === 0 ? (
        <div style={{ padding:40, textAlign:'center', fontFamily:'var(--font)', color:'var(--text3)', background:'white', border:'1px solid var(--border)' }}>
